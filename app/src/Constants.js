...
export const MODEL_FILES = [
	{ name: "Cornell Box 1", 		url: `${ASSETS_BASE_URL}/models/CornellBox1.glb`, preview: `${ASSETS_BASE_URL}/models/webp/CornellBox1.webp` },
	{ name: "Gameboy", 				url: `${ASSETS_BASE_URL}/models/Gameboy.glb`, preview: `${ASSETS_BASE_URL}/models/webp/Gameboy.webp` },
	{ name: "Stanford Bunny", 		url: `${ASSETS_BASE_URL}/models/StanfordBunny.glb`, preview: `${ASSETS_BASE_URL}/models/webp/StanfordBunny.webp` },
	{ name: "Table 1", 				url: `${ASSETS_BASE_URL}/models/Table1.glb`, preview: `${ASSETS_BASE_URL}/models/webp/Table1.webp` },
	{ name: "Table 2", 				url: `${ASSETS_BASE_URL}/models/Table2.glb`, preview: `${ASSETS_BASE_URL}/models/webp/Table2.webp` },
	{ name: "Ambassedor", 			url: `${ASSETS_BASE_URL}/models/ambassedor.glb`, preview: `${ASSETS_BASE_URL}/models/webp/ambassedor.webp` },
	{ name: "Antique Phone", 		url: `${ASSETS_BASE_URL}/models/antique_phone.glb`, preview: `${ASSETS_BASE_URL}/models/webp/antique_phone.webp` },
	{ name: "Bus Traveler", 		url: `${ASSETS_BASE_URL}/models/bus_traveler.glb`, preview: `${ASSETS_BASE_URL}/models/webp/bus_traveler.webp` },
	{ name: "C.W.M", 				url: `${ASSETS_BASE_URL}/models/c.w.m.glb`, preview: `${ASSETS_BASE_URL}/models/webp/c.w.webp` },
	{ name: "Camera", 				url: `${ASSETS_BASE_URL}/models/camera.glb`, preview: `${ASSETS_BASE_URL}/models/webp/camera.webp` },
	{ name: "Advanced Unit Blocks", url: `${ASSETS_BASE_URL}/models/cgt116_week_8_-_advanced_unit_blocks.glb`, preview: `${ASSETS_BASE_URL}/models/webp/cgt116_week_8_-_advanced_unit_blocks.webp` },
	{ name: "Diamond", 				url: `${ASSETS_BASE_URL}/models/diamond.glb`, preview: `${ASSETS_BASE_URL}/models/webp/diamond.webp` },
	{ name: "Diorama", 				url: `${ASSETS_BASE_URL}/models/diorama.glb`, preview: `${ASSETS_BASE_URL}/models/webp/diorama.webp` },
	{ name: "Dragon", 				url: `${ASSETS_BASE_URL}/models/dragon.glb`, preview: `${ASSETS_BASE_URL}/models/webp/dragon.webp` },
	{ name: "Ferrari", 				url: `${ASSETS_BASE_URL}/models/ferrari.glb`, preview: `${ASSETS_BASE_URL}/models/webp/ferrari.webp` },
	{ name: "Flashing Light", 		url: `${ASSETS_BASE_URL}/models/flashing_light.glb`, preview: `${ASSETS_BASE_URL}/models/webp/flashing_light.webp` },
	{ name: "Folliage", 			url: `${ASSETS_BASE_URL}/models/folliage.glb`, preview: `${ASSETS_BASE_URL}/models/webp/folliage.webp` },
	{ name: "Gelatinous Cube", 		url: `${ASSETS_BASE_URL}/models/gelatinous_cube.glb`, preview: `${ASSETS_BASE_URL}/models/webp/gelatinous_cube.webp` },
	{ name: "Helmet", 				url: `${ASSETS_BASE_URL}/models/helmet.glb`, preview: `${ASSETS_BASE_URL}/models/webp/helmet.webp` },
	{ name: "Jiotto Caspita F1", 	url: `${ASSETS_BASE_URL}/models/jiotto_caspita_f1_road_car_1989_by_alex.ka.glb`, preview: `${ASSETS_BASE_URL}/models/webp/jiotto_caspita_f1_road_car_1989_by_alex.ka.webp` },
	{ name: "Lemon", 				url: `${ASSETS_BASE_URL}/models/lemon.glb`, preview: `${ASSETS_BASE_URL}/models/webp/lemon.webp` },
	{ name: "Mercedes Mayback", 	url: `${ASSETS_BASE_URL}/models/mercedesmayback.glb`, preview: `${ASSETS_BASE_URL}/models/webp/mercedesmayback.webp` },
	{ name: "Model 3", 				url: `${ASSETS_BASE_URL}/models/model3.glb`, preview: `${ASSETS_BASE_URL}/models/webp/model3.webp` },
	{ name: "Modern Bathroom", 		url: `${ASSETS_BASE_URL}/models/modernbathroom.glb`, preview: `${ASSETS_BASE_URL}/models/webp/modernbathroom.webp` },
	{ name: "Old Stool", 			url: `${ASSETS_BASE_URL}/models/old_stool.glb`, preview: `${ASSETS_BASE_URL}/models/webp/old_stool.webp` },
	{ name: "Outdoor Sofaset", 		url: `${ASSETS_BASE_URL}/models/outdoorsofaset.glb`, preview: `${ASSETS_BASE_URL}/models/webp/outdoorsofaset.webp` },
	{ name: "Pagani Huayra Free", 	url: `${ASSETS_BASE_URL}/models/pagani_huayra_free.glb`, preview: `${ASSETS_BASE_URL}/models/webp/pagani_huayra_free.webp` },
	{ name: "Retro Telephone", 		url: `${ASSETS_BASE_URL}/models/retro_telephone_bordstelefon_tunnan.glb`, preview: `${ASSETS_BASE_URL}/models/webp/retro_telephone_bordstelefon_tunnan.webp` },
	{ name: "Road", 				url: `${ASSETS_BASE_URL}/models/road.glb`, preview: `${ASSETS_BASE_URL}/models/webp/road.webp` },
	{ name: "Rollerskates", 		url: `${ASSETS_BASE_URL}/models/rollerskates_race_-_inliner.glb`, preview: `${ASSETS_BASE_URL}/models/webp/rollerskates_race_-_inliner.webp` },
	{ name: "Scull Cup", 			url: `${ASSETS_BASE_URL}/models/scull_cup.glb`, preview: `${ASSETS_BASE_URL}/models/webp/scull_cup.webp` },
	{ name: "Mantel Clocks", 		url: `${ASSETS_BASE_URL}/models/simple_1800s_mantel_clocks.glb`, preview: `${ASSETS_BASE_URL}/models/webp/simple_1800s_mantel_clocks.webp` },
	{ name: "Skatin Jade Dragon", 	url: `${ASSETS_BASE_URL}/models/skatin_jade_dragon.glb`, preview: `${ASSETS_BASE_URL}/models/webp/skatin_jade_dragon.webp` },
	{ name: "Sony Walkman", 		url: `${ASSETS_BASE_URL}/models/sony_walkman_wm-f2078.glb`, preview: `${ASSETS_BASE_URL}/models/webp/sony_walkman_wm-f2078.webp` },
	{ name: "Spyglasscase", 		url: `${ASSETS_BASE_URL}/models/spyglasscase.glb`, preview: `${ASSETS_BASE_URL}/models/webp/spyglasscase.webp` },
	{ name: "Rolex Oyster", 		url: `${ASSETS_BASE_URL}/models/watch-rolex-oyster-perpetual.glb`, preview: `${ASSETS_BASE_URL}/models/webp/watch-rolex-oyster-perpetual.webp` },
	{ name: "Suzzane", 				url: `${ASSETS_BASE_URL}/models/suzzane.glb`, preview: `${ASSETS_BASE_URL}/models/webp/suzzane.webp` },
	{ name: "Laser Flashlight", 	url: `${ASSETS_BASE_URL}/models/zenitco_klesch-2p__laser_flashlight.glb`, preview: `${ASSETS_BASE_URL}/models/webp/zenitco_klesch-2p__laser_flashlight.webp` },
];
